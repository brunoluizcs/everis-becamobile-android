...
import com.nttdata.test.everis_becamobile_android.repository.IFilmsRepository
...
class FilmsViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return FilmsViewModel(filmsRepository,genresRepository, mediaType,timeWindow,language) as T
    }
